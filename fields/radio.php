...
$return[] = \WPO\Field::create( 'subheading', __( 'Multiple Radio' ) );
$return[] = \WPO\Field::create( 'radio', 'radio_2', __( 'Radio List' ) )
	->set_options( array(
		'option1' => __( 'Option 1' ),
		'option2' => __( 'Option 2' ),
		'option3' => __( 'Option 3' ),
...
$return[] = \WPO\Field::create( 'radio', 'radio_3', __( 'Radio Group List' ) )
...
$return[] = \WPO\Field::create( 'radio', 'radio_4', __( 'Long List of Radio' ) )
...
$improved_options = \WPO\Field::create( 'radio', 'radio_5', __( 'Radio with Improved Options' ) )
...
$improved_options->set_desc_field( 'All The above features will work with both list radio & group list radio <br/><strong>Code :</strong>' . $output );
$return[] = $improved_options;

$with_custom_input = \WPO\Field::create( 'radio', 'radio_6', __( 'Radio With Custom Input' ) );
...
$with_custom_input->set_desc_field( 'Radio With Custom Input Fields <br/><strong>Code : </strong>' . $code );
$return[] = $with_custom_input;


$return[] = WPO\Field::create( 'subheading', __( 'Dynamic Options' ) );
$return[] = WPO\Field::create( 'radio', 'radio_7', __( 'WP Pages As Options' ) )
	->set_options( 'pages' );
$return[] = WPO\Field::create( 'radio', 'radio_8', __( 'WP Post As Options' ) )
	->set_options( 'posts' );
$return[] = WPO\Field::create( 'radio', 'radio_9', __( 'WP Categories As Options' ) )
	->set_options( 'categories' );

$return[] = WPO\Field::create( 'radio', 'radio_10', __( 'WP Custom Post Type As Options' ) )
	->set_query_args( array( 'post_type' => 'your_post_type_name' ) )
	->set_desc_field( wponion_highlight_string( var_export( array(
		'post_type' => 'your_post_type_name',
	), true ) ) );
$return[] = WPO\Field::create( 'radio', 'radio_11', __( 'WP Categories As Options' ) )
	->set_options( 'categories' )
