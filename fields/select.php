...
$return[]    = \WPO\Field::create( 'select', 'select_11', 'Select2 Classic Theme' )
	...
	->desc_field( '<strong>Code</strong>' . wponion_highlight_string( array( 'select2' => array( 'theme' => 'classic' ) ) ) );
...
$custom_view->desc_field( '<strong>Code</strong>' . wponion_highlight_string( array( 'select2' => $custom_view['select2'] ) ) );
$return[] = $custom_view;
...
$return[] = WPO\Field::create( 'notice' )
	->content( 'Selectize Requires WPOnion Selectize Addon To Be Installed ' )
	->notice_type( 'warning' );
